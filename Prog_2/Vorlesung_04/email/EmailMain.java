...
public class EmailMain {
	...
	public static void main(String[] args) {
		...
		emails[3] = new Email("Geburtstag", "Hallo Maria, ich wollte dir alles Gute zum geb urtstag wünschen. Ich hoffe du machst dir einen schönen Tag und lässt dich ordentlich feiern.\nLiebe Grüße\nKira");
		...
		emails[13] = new Email("Kino", "Hey Mädels,\nam Samstag kommt der Goldene Handschuh in die Kinos. Da gabs ja auch ein Buch zu, das war schon echt krass. Lass uns da mal hingehen.\nGrüße\nLaura");
...
//		String regex = "(Haus) | (Häuser)";								//wonach wird gesucht
...
//		String regex = "(\\s|^)[Ss]\\w*[e](\\s|[.,?!:;])";
		...
		for (Email email : emails) {									//schleife mit Matcher durchläuft die E-Mails
